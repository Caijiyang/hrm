...
public class DeptServlet extends HttpServlet {
    ...
    private void selectPage(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 执行分页条件查询
        List<Dept> depts = service.selectPage(page, condition);
...
//                selectAll(req, resp);
    ...
    private void insert(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 调用DeptService中的方法实现新增
        int row = service.insert(dept);
        if (row == 1) {
//            selectAll(req, resp);
            selectPage(req, resp);
//            req.getRequestDispatcher("dept/dept.jsp").forward(req, resp);
            ...
            // 添加失败
            req.getRequestDispatcher("dept/showAddDept.jsp").forward(req, resp);
        }
    }
