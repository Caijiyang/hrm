...
function loadMenu(){
	...
	+'"childs": [{"id": "111","name": "用户查询","icon": "","url": "user?operation=selectPage","parentId": "11",'
	...
	+'"childs": [{"id": "121","name": "部门查询","icon": "","url": "dept?operation=selectPage","parentId": "12",'
	...
	+'"childs": [{"id": "141","name": "职位查询","icon": "","url": "job?operation=selectPage","parentId": "14",'
	...
	+'"childs": [{"id": "151","name": "员工查询","icon": "","url": "employee?operation=selectPage","parentId": "15",'
	+'"childs": []},{"id": "152","name": "添加员工","icon": "","url": "employee?operation=add","parentId": "15",'
	+'"childs": []},{"id": "152","name": "员工统计","icon": "","url": "employee?operation=statistics","parentId": "15",'
	+'"childs": []}]},{"id": "16","name": "公告管理","icon": "/xingxing.png","url": "notice/notice.jsp","parentId": "1",'
	+'"childs": [{"id": "161","name": "公告查询","icon": "","url": "notice?operation=selectPage","parentId": "16",'
	+'"childs": []},{"id": "162","name": "添加公告","icon": "","url": "notice/showAddNotice.jsp","parentId": "16",'
	+'"childs": []}]},{"id": "17","name": "下载中心","icon": "/xingxing.png","url": "document/document.jsp","parentId": "1",'
	+'"childs": [{"id": "171","name": "文档查询","icon": "","url": "document?operation=selectPage","parentId": "17",'
