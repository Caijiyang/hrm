...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
                    ...
                    <td class="fftd">
                        ...
                        <form action="/dept" method="post">
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">
                                        部门名称：<input type="text" name="name" value="${name==null ? "" : name}">
    ...
    <tr valign="top">
        <td height="20">
            <form id="del_form" action="/dept" method="post">
                ...
                <table width="100%" border="1" cellpadding="5" cellspacing="0"
                    ...
                    <c:forEach items="${depts}" var="dept">
                        <tr id="data_0" align="center" class="main_trbg" style="background-color: rgb(255, 255, 255);">
                            <td><input type="checkbox" name="ids" id="box_0" value="${dept.id}"></td>
                            <td>${dept.name}</td>
                            <td>${dept.remark}</td>
                            <td align="center" width="40px;">
                                <a href="/dept?operation=update&id=${dept.id}">
                ...
                <tr>
                    <td style="COLOR: #0061de; MARGIN-RIGHT: 3px; PADDING-TOP: 2px; TEXT-DECORATION: none">
                        ...
                        <c:if test='${page.pageNum > 1}'>
                            <a href="/dept?operation=selectPage&pageNum=${page.pageNum - 1}&name=${requestScope.name}">
                                <span>上一页</span>
                            </a>
                        </c:if>
                        ...
                        <c:forEach begin="1" end="${page.totalPage}" var="index">
                            ...
                            <c:if test="${page.pageNum != index}">
                                <a href="/dept?operation=selectPage&pageNum=${index}&name=${requestScope.name}">
                                    <span>${index}</span>
                                </a>
                            </c:if>
                        </c:forEach>
