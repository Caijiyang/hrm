    ...
    <script type="text/javascript">
        ...
        function submit() {
            ...
            if (msg != "") {
            	...
            	// $("#form1") : 等价于 document.getElementById("form1");
				// 等价于document.getElementById("form1").submit();
				$("#form1").submit();
                return true;
            }
        }
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
    <tr valign="top">
        <td>
            <%--
                由于showAddUser.jsp页面所在的目录为web/user目录，而不是web目录
                所以，该页面中所有的相对路径都是以web/user作为根目录的
                使用以 / 开头的绝对路径，是以web目录作为根目录的
             --%>
